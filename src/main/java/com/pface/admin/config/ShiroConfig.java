...
import com.pface.admin.core.shiro.filter.CaptchaValidateFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        //filterChainDefinitionMap.put("/pface/**", "anon");
        filterChainDefinitionMap.put("/pubfile/**", "anon");
        ...
        filterChainDefinitionMap.put("/admin/login","captchaVaildate,authc");
    ...
    public DefaultWebSessionManager sessionManager() {
        ...
        sessionManager.setGlobalSessionTimeout(88400000L);//1800000L
...
//        sessionManager.setSessionValidationScheduler(sessionValidationScheduler);
    ...
    public QuartzSessionValidationScheduler sessionValidationScheduler(DefaultWebSessionManager sessionManager) {
        ...
        sessionValidationScheduler.setSessionValidationInterval(88400000L);
