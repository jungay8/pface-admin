 ...
 */
package com.pface.admin.core.web;

import com.google.common.net.HttpHeaders;


import com.pface.admin.core.utils.Encodes;
...
public class Servlets {
	...
	// 静态文件后缀
	private final static String[] staticFiles = {".css",".js",".png",".jpg",".gif",".jpeg",".bmp",".ico",".swf",".psd"};

	// 动态映射URL后缀
	private final static String urlSuffix = "views";
