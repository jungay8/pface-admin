...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static String getMessage(String code, Object[] args) {
		LocaleResolver localLocaleResolver = (LocaleResolver) SpringUtils.getBean(LocaleResolver.class);
	...
	public static List<Integer> trans2long(String str,String splitStr){
       ...
       if(org.apache.commons.lang3.StringUtils.isNotEmpty(str)){
           ...
           for(int i=0,s=strs.length;i<s;i++){
				try {
					...
					System.out.println("id="+strs[i]+"\t emsg:"+e.getMessage());
					continue;
				 }
		   }
	   }
