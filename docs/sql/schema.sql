drop table if exists jmgo_sys_user;
drop table if exists jmgo_sys_organization;
drop table if exists jmgo_sys_resource;
drop table if exists jmgo_sys_role;
drop table if exists jmgo_sys_group;
drop table if exists jmgo_sys_log;

create table jmgo_sys_user (
...
create unique index idx_sys_user_username on jmgo_sys_user(username);
create index idx_sys_user_organization_id on jmgo_sys_user(organization_id);

create table jmgo_sys_organization (
  id bigint auto_increment COMMENT '编号',
...
create index idx_sys_organization_parent_id on jmgo_sys_organization(parent_id);
create index idx_sys_organization_parent_ids on jmgo_sys_organization(parent_ids);

create table jmgo_sys_resource (
  id bigint auto_increment COMMENT '编号',
...
create index idx_sys_resource_parent_id on jmgo_sys_resource(parent_id);
create index idx_sys_resource_parent_ids on jmgo_sys_resource(parent_ids);

create table jmgo_sys_role (
  id bigint auto_increment COMMENT '编号',
...
create index idx_sys_role_resource_ids on jmgo_sys_role(resource_ids);

CREATE TABLE jmgo_sys_group (
  id bigint AUTO_INCREMENT COMMENT '编号',
